...
# requirement_ticket.txt 裡有我們需要的套件資訊， 
# 把他複製到container裡，路徑為 /app/requirement_ticket.txt
COPY ./requirement_ticket.txt /app/requirement_ticket.txt

RUN pip install -r app/requirement_ticket.txt
